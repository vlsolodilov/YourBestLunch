...
import com.yourbestlunch.repository.UserRepository;
import com.yourbestlunch.to.UserTo;
import com.yourbestlunch.util.JsonUtil;
import com.yourbestlunch.util.UserUtil;
...
import static com.yourbestlunch.web.user.ProfileController.REST_URL;
...
class ProfileControllerTest extends AbstractControllerTest {
    ...
    void delete() throws Exception {
        ...
        UserTestData.USER_MATCHER.assertMatch(userRepository.findAll(), UserTestData.admin,
                UserTestData.user2, UserTestData.user3, UserTestData.user4);
    }
