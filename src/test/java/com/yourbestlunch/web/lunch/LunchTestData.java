...
public class LunchTestData {
    public static final MatcherFactory.Matcher<LunchItem> LUNCH_MATCHER = MatcherFactory.usingEqualsComparator(LunchItem.class);

    public static final int LUNCH_ID_1 = 1;
    public static final int LUNCH_ID_6 = 6;
    public static final int NOT_FOUND = 100;

    public static final LocalDate LUNCH_DATE = LocalDate.of(2022, 1, 13);
